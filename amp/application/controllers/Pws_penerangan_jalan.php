...
class Pws_penerangan_jalan extends CI_Controller {
	...
	public function index()
	{
		...
		$this->template->load('template','pengawasan/penerangan_jalan/pws_hotel_data', $data);
    }
