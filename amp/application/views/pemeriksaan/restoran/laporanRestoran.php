    ...
    <div class="box">
        <div class="box-header with-border">
            ...
            <div class="pull-right">
                <a href="<?= site_url('prs_restoran/add')?>" class="btn bg-teal btn-flat">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <a href="<?= site_url('prs_restoran/cek/'.$data->no_pws)?>" class="btn btn-primary btn-sm">
                                <i class="fa fa-eye"></i> LIHAT
                            </a> 
                            <a href="<?= site_url('prs_restoran/del/'.$data->no_pws)?>" class="btn btn-danger btn-sm">
...
<script>
        ...
        document.location.href = "<?=base_url('/')?>prs_restoran";
    </script>