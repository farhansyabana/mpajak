      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview <?=$this->uri->segment(1) == 'prs_hotel' || $this->uri->segment(1) == 'prs_hiburan' || $this->uri->segment(1) == 'prs_restoran' ? 'active' : '' ?>">
          ...
          <ul class="treeview-menu">
            ...
            <li <?=$this->uri->segment(1) == 'prs_hiburan' ? 'class="active"' : '' ?>><a href="<?=site_url('prs_restoran')?>"><i class="fa fa-dot-circle-o"></i> Pajak Restoran</a></li>
            <li <?=$this->uri->segment(1) == 'prs_restoran' ? 'class="active"' : '' ?>><a href="<?=site_url('prs_hiburan')?>"><i class="fa fa-dot-circle-o"></i> Pajak Hiburan</a></li>
            <li <?=$this->uri->segment(1) == 'prs_raklame' ? 'class="active"' : '' ?>><a href="<?=site_url('prs_raklame')?>"><i class="fa fa-dot-circle-o"></i> Pajak Raklame</a></li>
            <li <?=$this->uri->segment(1) == 'prs_restoran' ? 'class="active"' : '' ?>><a href="<?=site_url('prs_penerangan jalan')?>"><i class="fa fa-dot-circle-o"></i> Pajak Penerangan jalan</a></li>
            <li <?=$this->uri->segment(1) == 'prs_restoran' ? 'class="active"' : '' ?>><a href="<?=site_url('prs_parkir')?>"><i class="fa fa-dot-circle-o"></i> Pajak Parkir</a></li>
            <li <?=$this->uri->segment(1) == 'prs_restoran' ? 'class="active"' : '' ?>><a href="<?=site_url('prs_sarang burung walet')?>"><i class="fa fa-dot-circle-o"></i> Pajak Sarang burung walet</a></li>
            <li <?=$this->uri->segment(1) == 'prs_restoran' ? 'class="active"' : '' ?>><a href="<?=site_url('prs_air tanah')?>"><i class="fa fa-dot-circle-o"></i> Pajak Air tanah</a></li>
            <li <?=$this->uri->segment(1) == 'prs_restoran' ? 'class="active"' : '' ?>><a href="<?=site_url('prs_bumi dan bangunan')?>"><i class="fa fa-dot-circle-o"></i> Pajak Bumi dan bangunan</a></li>
          </ul>
        </li>
        <li class="treeview <?=$this->uri->segment(1) == 'prs_hotel' || $this->uri->segment(1) == 'prs_hiburan' || $this->uri->segment(1) == 'prs_restoran' ? 'active' : '' ?>">
          <a href="#">
            <i class="fa fa-pencil-square-o"></i> <span>Laporan</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
            <li <?=$this->uri->segment(1) == 'prs_hotel' ? 'class="active"' : '' ?>><a href="<?=site_url('prs_hotel')?>"><i class="fa fa-dot-circle-o"></i>Cetak Pajak Pajak Hotel</a></li>
            <li <?=$this->uri->segment(1) == 'prs_hiburan' ? 'class="active"' : '' ?>><a href="<?=site_url('prs_restoran')?>"><i class="fa fa-dot-circle-o"></i> Pajak Restoran</a></li>
            <li <?=$this->uri->segment(1) == 'prs_restoran' ? 'class="active"' : '' ?>><a href="<?=site_url('prs_hiburan')?>"><i class="fa fa-dot-circle-o"></i> Pajak Hiburan</a></li>
            <li <?=$this->uri->segment(1) == 'prs_restoran' ? 'class="active"' : '' ?>><a href="<?=site_url('prs_raklame')?>"><i class="fa fa-dot-circle-o"></i> Pajak Raklame</a></li>
            <li <?=$this->uri->segment(1) == 'prs_restoran' ? 'class="active"' : '' ?>><a href="<?=site_url('prs_penerangan jalan')?>"><i class="fa fa-dot-circle-o"></i> Pajak Penerangan jalan</a></li>
            <li <?=$this->uri->segment(1) == 'prs_restoran' ? 'class="active"' : '' ?>><a href="<?=site_url('prs_parkir')?>"><i class="fa fa-dot-circle-o"></i> Pajak Parkir</a></li>
            <li <?=$this->uri->segment(1) == 'prs_restoran' ? 'class="active"' : '' ?>><a href="<?=site_url('prs_sarang burung walet')?>"><i class="fa fa-dot-circle-o"></i> Pajak Sarang burung walet</a></li>
            <li <?=$this->uri->segment(1) == 'prs_restoran' ? 'class="active"' : '' ?>><a href="<?=site_url('prs_air tanah')?>"><i class="fa fa-dot-circle-o"></i> Pajak Air tanah</a></li>
