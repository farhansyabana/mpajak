...
<head>
    ...
    <title>Pengawasan Hiburan <?=$row->no_pws?></title>
    <style>
        td.atas{
            font-size:15px;
        }
...
<body>
    <div style="width: 95%; margin-left: auto; margin-right: auto;">
            ...
            <tbody>
                <tr>
                    ...
                    <td width="90%" style="text-align:center">
                        ...
                        <p style="text-align:center; font-size:24px; line-height: 1em"><b>BADAN PENDAPATAN DAERAH</b></p>
                        <p style="text-align:center; font-size:15px; line-height: 1em">Tanjung, Kec Tanjung , Kabupaten Tabalong, Kalimantan Selatan 71513</p>
                    </td>
                </tr>
            <tbody>
        </table>
        ...
        <p style="font-size:16px; line-height:70%"><b>SURAT PENGAWASAN PAJAK HIBURAN</b></p>
        <table>
            <tbody>
