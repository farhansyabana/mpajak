                        ...
                        <div class="col-md-8 col-md-offset-2">
                            ...
                            <ul class="list-group list-group-unbordered">
                                ...
                                <?php } else if ($log->npwpd == null && $log->level == '1') { ?>
                                    <li class="list-group-item">
                                        <b>Instansi</b> <p class="pull-right">Badan Pendapatan Daerah Kabupaten Tabalong</a>
                                    </li>
                                    <li class="list-group-item">
                                        <b>Alamat</b> <p class="pull-right">Tanjung, Kec Tanjung , Kabupaten Tabalong, Kalimantan Selatan 71513</a>
                                    </li>
                                <?php } else { ?>
                                    <li class="list-group-item">
