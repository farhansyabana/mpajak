                ...
                <div class="row">
                    <div class="col-md-2">
                        ...
                        <select name="tipenya" class="form-control" id="tipenya">
                            ...
                            <option value="raklame" <?=set_value('tipenya') == "raklame" ? "selected" : null?>> Reklame </option>
                            <option value="penerangan jalan" <?=set_value('tipenya') == "penerangan jalan" ? "selected" : null?>> Penerangan Jalan </option>
                            <option value="parkir" <?=set_value('tipenya') == "parkir" ? "selected" : null?>> Parkir </option>
                            <option value="sarang burung walet" <?=set_value('tipenya') == "sarang burung walet" ? "selected" : null?>> Sarang Burung Walet </option>
                            <option value="air tanah" <?=set_value('tipenya') == "air tanah" ? "selected" : null?>> Air tanah </option>
                            <option value="bumi dan bangunan" <?=set_value('tipenya') == "bumi dan bangunan" ? "selected" : null?>> Bumi dan Bangunan </option>
