...
<section class="content">
    <div class="box">
        <div class="box-header with-border">
            <h3 class="box-title">Data Pemeriksaan Pajak Hotel Nomor : <?= $prs2->no_pws?></h3>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <a href="<?= site_url('prs_hotel/edit/'.$data->id_htl)?>" class="btn btn-info btn-sm">
        ...
        <div class="box-body">
            <div class="pull-right">
                <a href="<?= site_url('prs_hotel/hasil/'.$data->no_pws)?>" target="blank" class="btn bg-green btn-flat">
