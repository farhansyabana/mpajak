...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 26 Jan 2024 pada 08.24
...
(58, 'htl-2008110001', '2013.01.02.0035', 2, '2023-08-05', 1000000, 1000000, 0, 0, 0, 0, '2023-08-05'),
(59, 'htl-2008110001', '2013.01.02.0035', 2, '2023-08-05', 1000000, 4989834, -3989834, -398983, 0, -398983, '2023-08-05'),
(60, 'htl-2008110001', '2013.01.02.0035', 2, '2023-08-05', 322243, 8782362, -8460119, -846012, 0, -846012, '2023-08-05'),
(61, 'htl-2008110001', '2013.01.02.0035', 2, '2023-08-05', 11343353, 42354644, -31011291, -3101129, 0, -3101129, '2023-08-05'),
(62, 'htl-2008110001', '2013.01.02.0035', 2, '2023-08-05', 4245334, 2147483647, -2147483648, -656140112, 0, -656140112, '2023-08-05'),
(63, 'htl-2008110001', '2013.01.02.0035', 2, '2023-08-05', 646443, 6435353, -5788910, -578891, 0, -578891, '2023-08-05');

-- --------------------------------------------------------

--
-- Struktur dari tabel `prs_reklame`
--

CREATE TABLE `prs_reklame` (
  `id_htl` int(11) NOT NULL,
  `no_pws` varchar(30) NOT NULL,
  `npwpd` varchar(20) NOT NULL,
  `tipe_id` int(11) NOT NULL,
...
--
-- Dumping data untuk tabel `prs_reklame`
--

INSERT INTO `prs_reklame` (`id_htl`, `no_pws`, `npwpd`, `tipe_id`, `periode`, `omset_sptpd`, `omset_periksa`, `omset_kurang`, `pajak_kurang`, `denda`, `total`, `dibuat`) VALUES
(22, 'htl-2002030001', '2013.01.02.0035', 2, '2019-07-01', 21400000, 21400000, 0, 0, 0, 0, '2020-08-12'),
(23, 'htl-2002030001', '2013.01.02.0035', 2, '2019-08-01', 21620000, 21620000, 0, 0, 0, 0, '2020-08-12'),
(24, 'htl-2002030001', '2013.01.02.0035', 2, '2019-09-01', 21950000, 21950000, 0, 0, 0, 0, '2020-08-12'),
(25, 'htl-2002030001', '2013.01.02.0035', 2, '2019-10-01', 21780000, 21780000, 0, 0, 0, 0, '2020-08-12'),
...
(13, 'rst-2008060001', '2014.01.03.0021', 1, '2023-11-21', 26500000, 26500000, 0, 0, 0, 0, '2023-08-23'),
...
('hbr-2002030003', '2020-02-03', '2010.01.02.0052', 4, 'ada', 'benar', 'pws-200811-79ff7cdf6b.pdf', 'ada', 'ada', 'pws-200811-79ff7cdf6b1.pdf', 'ada', 'ya', 'ya', 'ya', '2020-01-08', '', 0, 'Y'),
('hbr-2002100002', '2020-02-10', '2017.01.02.0102', 3, 'ada', 'benar', 'pws-200811-9cc1a21ad0.pdf', 'tidak', 'ada', 'pws-200811-9cc1a21ad01.pdf', 'ada', 'ya', 'ya', 'ya', '2020-01-20', '', 0, 'Y'),
('hbr-2008110001', '2020-08-11', '2012.01.02.0048', 5, 'ada', 'benar', 'pws-200811-20a277fea3.pdf', 'ada', 'ada', NULL, 'ada', 'ya', 'ya', 'ya', '2020-07-20', '', 0, 'T'),
('hbr-2008110002', '2020-08-11', '2015.01.03.0008', 4, 'ada', 'benar', 'pws-200811-46846626f1.pdf', 'ada', 'ada', 'pws-200811-46846626f11.pdf', 'ada', 'ya', 'ya', 'ya', '2020-07-02', '', 0, 'Y'),
('hbr-2008120001', '2020-08-12', '2017.01.02.0102', 3, 'ada', 'benar', 'pws-200811-dd99e3abb9.pdf', 'ada', 'ada', 'pws-200811-dd99e3abb91.pdf', 'ada', 'ya', 'ya', 'tidak', '2020-07-17', '', 0, 'Y');
...
('htl-2008110001', '2020-08-11', '2013.01.02.0035', 2, 'ada', 'benar', NULL, 'ada', 'ada', 'pws-200811-84b0394652.pdf', 'ada', 'ya', 'ya', 'ya', 'ya', '2020-07-20', '', 6, 'T'),
...
CREATE TABLE `tipe_wp` (
  `tipe_id` int(11) NOT NULL,
  `ket_tipe` varchar(255) NOT NULL,
  `jenis_tipe` varchar(255) NOT NULL,
...
(1, 'hotel', 'hotel', 10),
(2, 'restoran', 'restoran', 10),
(3, 'hiburan', 'hiburan', 10),
(4, 'reklame', 'reklame', 10),
(5, 'penerangan_jalan', 'penerangan_jalan', 10),
(6, 'parkir', 'parkir', 10),
(7, 'sarang_burung_walet', 'sarang_burung_walet', 10),
(8, 'air_tanah', 'air_tanah', 10),
(9, 'pbb', 'pbb', 10);
...
(1, 'Admin', '21232f297a57a5a743894a0e4a801fc3', 'Farhan Syabana', NULL, 1),
...
(18, 'rattan1', '15e620dd81ebc8ec65a34634ee6dddf2', 'Hotel Hikmah', '2013.01.02.0012', 2),
(19, 'hotel5', '3f8a6abf5fbfd8bc16dab9b35a6bf17e', 'Hotel Fave', '2013.01.02.0035', 2),
(20, 'bunda', '55b0c86ed75326a42b7a48c3fbf67baf', 'DEPOT KITA', '2012.01.02.0044', 2),
(21, 'karaokenav', '1efd6f89ca9584ba8fc2a6771f8c5649', 'Nav Karaoke', '2012.01.02.0048', 2),
(22, 'pesona1', '47ca7441074215bc2b3a030950f9ad45', 'Hotel Jelita', '2012.01.02.0025', 2),
(23, 'resto1', 'cfd242d4258aaef4feb624eedfe22035', 'Rumah Makan Ibu Ida', '2012.01.02.0028', 2),
...
(27, 'depot1', '4ff862cb426f796285fdde264c46115e', ' Depot Soto Cak Hari', '2010.01.02.0014', 2),
...
(31, 'baru123', '4ba2c6eb5a0045c66a09a12be73e822a', 'Warung Bakacak', '2019.01.03.0011', 2),
...
(34, 'wajibpajak', '3ef42620629611862d1678859cb34b32', 'Farhan Syabana', NULL, 2),
(35, 'admin1', 'e00cf25ad42683b3df678c61f42c6bda', 'Farhan Syabana', NULL, 1),
(36, 'lalak', '1c1907bdd6687e5e1c746aca6a4cdf50', ' Depot Soto Cak Hari', '76567757', 2);
...
('2010.01.02.0014', ' Depot Soto Cak Hari', 1, 'Shafwati', 'Jalan Tunjungan', '08115116164', 'depot1'),
('2010.01.02.0052', 'Nashville HBI', 4, 'Eri Sudarisman', 'Jl. A. Yani KM.4,5, Karang Mekar', '05113251008', 'hiburan2'),
('2012.01.02.0002', 'Hotel Aston', 2, 'Andri Kurniawan', 'Jln. Jend. A. Yani Mabuun', '05116745555', 'hotel1'),
('2012.01.02.0025', 'Hotel Jelita', 2, 'Farhan', 'Jalan Pembataan', '05113302919', 'pesona1'),
('2012.01.02.0028', 'Rumah Makan Ibu Ida', 1, 'Ibu Ida', 'Jl. Pasar Kapar', '085332900199', 'resto1'),
('2012.01.02.0044', 'DEPOT KITA', 1, 'DEPOT KITA', 'Jl. A Yani Maburai', '0811514566', 'bunda'),
('2012.01.02.0048', 'Nav Karaoke', 5, 'Herman Dinata', 'Jalan A. Yani KM.2,5 No.86', '05113268989', 'karaokenav'),
('2013.01.02.0012', 'Hotel Hikmah', 2, 'Hikmah', 'Jl Pasar Tanjung', '05113267799', 'rattan1'),
...
('2014.01.03.0021', 'Rumah Makan Lontong Orari', 1, 'Bainah', 'Jalan Tanjung Tengah', '05116782672', 'orari'),
...
('2017.01.03.0008', 'Rocket Chicken', 1, 'Farhan', 'JL. Pandan Arum', '081393131130', 'roket1'),
...
('2019.01.03.0011', 'Warung Bakacak', 1, 'Arif ', 'Jl, Bangun Sari no 11', '05119900990', 'baru123'),
('76567757', ' Depot Soto Cak Hari', 1, 'lalak sayangg', 'mjk', '0897979', 'lalak');
...
--
ALTER TABLE `prs_hotel`
  MODIFY `id_htl` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=65;
